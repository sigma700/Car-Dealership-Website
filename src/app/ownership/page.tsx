      ...
      <section className="relative h-screen overflow-hidden">
        ...
        >
          <motion.p
            ...
            className="text-[10px] md:text-xs tracking-[0.35em] text-[#BCBEC0] mb-8 uppercase"
          >
            Ownership Redefined
          </motion.p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-8 max-w-5xl">
            ...
            >
              ...
              <Button variant="outline" size="md" href="/models">
          ...
          <motion.div
            ...
            className="absolute bottom-8 right-8 md:right-16 flex items-center gap-3 text-[#BCBEC0]/30"
          >
            <motion.div
...
function TrustStrip() {
  ...
  return (
    <div ref={ref} className="border-t border-b border-[#BCBEC0]/20 bg-black">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x divide-[#BCBEC0]/20">
        {stats.map((s, i) => (
          <motion.div
            key={i}
          ...
          >
            <span className="font-mono text-2xl md:text-3xl text-[#BCBEC0]">
              {s.value}
            </span>
            <span className="text-[10px] tracking-[0.2em] text-[#BCBEC0]/40 uppercase">
              {s.label}
            </span>
          </motion.div>
        ))}
      ...
      <div className="sticky top-0 h-screen overflow-hidden flex">
        <div className="relative w-full lg:w-[58%] h-full">
          ...
          <motion.div
            ...
            style={{color: "rgba(188,190,192,0.12)"}}
          >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="font-mono text-3xl text-[#BCBEC0]">
                {ownershipJourney[activeStep].stat}
              </div>
              <div className="text-[10px] tracking-[0.2em] text-[#BCBEC0]/50 uppercase mt-1">
                {ownershipJourney[activeStep].statLabel}
              </div>
            </motion.div>
          </AnimatePresence>
        </div>
        <div className="hidden lg:flex w-[42%] h-full flex-col justify-between bg-black px-10 xl:px-16 py-16 border-l border-[#BCBEC0]/20">
          <div>
            <p className="text-[10px] tracking-[0.35em] text-[#BCBEC0] uppercase mb-16">
              The Journey
            </p>
              ...
              {ownershipJourney.map((step, i) => (
                ...
                >
                  <span
                    ...
                    style={{color: i === activeStep ? "#BCBEC0" : "#BCBEC0"}}
                  >
                    {step.step}
                  </span>
                  ...
                  <span
                    ...
                    style={{color: i === activeStep ? "#FFFFFF" : "#BCBEC0"}}
                  >
                    {step.title}
                  </span>
                </motion.button>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="font-display text-4xl xl:text-5xl text-white leading-[0.92]">
                {ownershipJourney[activeStep].title}
              </h2>
              <p className="text-sm text-[#BCBEC0]/55 leading-relaxed max-w-sm">
          ...
          <div className="border-t border-[#BCBEC0]/20 pt-6">
            <p className="text-[10px] tracking-[0.2em] text-[#BCBEC0]/30 uppercase mb-1">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{opacity: 0}}
            transition={{duration: 0.5, ease: EASE_OUT_EXPO}}
            className="lg:hidden absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent px-6 pb-8 pt-20"
          >
            <p className="text-[10px] tracking-[0.3em] text-[#BCBEC0] uppercase mb-2">
              {ownershipJourney[activeStep].step} — The Journey
            </p>
            <h2 className="font-display text-3xl text-white mb-3">
              {ownershipJourney[activeStep].title}
            </h2>
            <p className="text-xs text-[#BCBEC0]/60 leading-relaxed max-w-sm">
              {ownershipJourney[activeStep].description}
            </p>
              ...
              {ownershipJourney.map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    background: i === activeStep ? "#BCBEC0" : "#BCBEC0" + "33",
                  }}
                />
              ))}
            </div>
    ...
    <section ref={sectionRef} className="relative bg-white overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            <span className="font-mono text-[6rem] leading-none text-[#BCBEC0]/15 select-none">
              02
            </span>
          </motion.div>
          <div className="lg:col-span-5">
            <motion.p
              ...
              className="text-[10px] tracking-[0.35em] text-[#BCBEC0] uppercase mb-5"
            >
              Delivery
            </motion.p>
            <div className="overflow-hidden">
              ...
              >
                Arrives in
                <br />
                <span className="text-[#BCBEC0] italic">perfection.</span>
              </motion.h2>
            </div>
          </div>
          <motion.div
            ...
            transition={{duration: 0.9, ease: EASE_OUT_EXPO, delay: 0.4}}
          >
            <p className="text-sm text-[#BCBEC0]/80 leading-relaxed mb-8">
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <motion.li
                  ...
                  className="flex items-center gap-3 text-xs text-[#BCBEC0] tracking-wide"
                >
            ...
            >
              Arrange Delivery <span className="ml-2">→</span>
            </Button>
          </motion.div>
        </div>
        <motion.div
        ...
        <motion.div
          className="mt-16 overflow-hidden border-t border-black/10 pt-6"
          style={
            prefersReduced
              ? {}
              : {
        ...
        >
          <p className="font-display text-[3.5rem] md:text-[5rem] text-black/5 whitespace-nowrap leading-none tracking-tight select-none">
...
function ConciergeProgramme() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-black overflow-hidden py-28 md:py-40"
    >
      <div
        className="absolute inset-0 opacity-30 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse at 20% 50%, rgba(188,190,192,0.08) 0%, transparent 60%), radial-gradient(ellipse at 80% 50%, rgba(188,190,192,0.05) 0%, transparent 60%)",
        }}
      />
      <div className="relative max-w-[1440px] mx-auto px-6 md:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20 items-end">
          <div>
            <motion.p
              ...
              animate={inView ? {opacity: 1, x: 0} : {}}
              transition={{duration: 0.7, ease: EASE_OUT_EXPO}}
              className="text-[10px] tracking-[0.35em] text-[#BCBEC0] uppercase mb-4"
            >
              Concierge Programme
            </motion.p>
            <div className="overflow-hidden">
              ...
              >
                Life,
                <br />
                <span className="text-[#BCBEC0] italic">simplified.</span>
              </motion.h2>
            </div>
          </div>
          <motion.p
        ...
        <div className="border-t border-[#BCBEC0]/20">
          {pillars.map((p, i) => (
            <motion.div
              ...
              className="group grid grid-cols-12 items-center gap-6 py-7 border-b border-[#BCBEC0]/20 hover:border-[#BCBEC0]/30 transition-colors duration-500 cursor-default"
            >
              <span className="col-span-1 font-mono text-xs text-[#BCBEC0]/20 group-hover:text-[#BCBEC0]/40 transition-colors duration-300">
                {String(i + 1).padStart(2, "0")}
              </span>
              <span className="col-span-1 text-xl text-[#BCBEC0]/40 group-hover:text-[#BCBEC0] transition-colors duration-400">
                {p.icon}
              </span>
              <h3 className="col-span-3 font-display text-lg md:text-xl text-white group-hover:text-[#BCBEC0] transition-colors duration-300">
                {p.title}
              </h3>
              <p className="col-span-6 text-xs text-[#BCBEC0]/40 leading-relaxed group-hover:text-[#BCBEC0]/70 transition-colors duration-400">
                {p.body}
              </p>
              <motion.span className="col-span-1 text-[#BCBEC0] text-sm justify-self-end opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                →
              </motion.span>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <Button variant="outline" size="md" href="/contact?subject=concierge">
            Enquire About Concierge <span className="ml-2">→</span>
          </Button>
        </motion.div>
      </div>
    </section>
      ...
      <div className="flex flex-col lg:flex-row min-h-[80vh]">
        <div className="w-full lg:w-1/2 px-6 md:px-16 py-24 md:py-32 flex flex-col justify-center">
          <motion.p
            ...
            animate={inView ? {opacity: 1, x: 0} : {}}
            transition={{duration: 0.7, ease: EASE_OUT_EXPO}}
            className="text-[10px] tracking-[0.35em] text-[#BCBEC0] uppercase mb-6"
          >
            Maintenance & Care
          </motion.p>
          <div className="overflow-hidden mb-6">
            ...
            >
              Five years of
              <br />
              <span className="text-[#BCBEC0] italic">absolute certainty.</span>
            </motion.h2>
          </div>
          <motion.p
            initial={{opacity: 0, y: 16}}
            ...
            className="text-sm text-[#BCBEC0]/80 leading-relaxed max-w-md mb-10"
          >
          ...
          <div className="grid grid-cols-3 gap-6 mb-10 border-t border-black/10 pt-8">
            {[
              ...
              >
                <div className="font-mono text-3xl md:text-4xl text-[#BCBEC0] leading-none mb-1">
                  {s.value}
                  {s.unit && <span className="text-base ml-0.5">{s.unit}</span>}
                </div>
                <div className="text-[10px] tracking-[0.15em] text-[#BCBEC0]/50 uppercase">
                  {s.label}
                </div>
              </motion.div>
            ))}
          ...
          <motion.blockquote
            ...
            className="border-l-2 border-[#BCBEC0] pl-5"
          >
            <p className="text-sm text-[#BCBEC0] italic leading-relaxed mb-2">
              "They collect my car, leave a courtesy vehicle, and return it
              polished. Every single time."
            </p>
            <footer className="text-[10px] tracking-[0.2em] text-[#BCBEC0] uppercase">
...
function ExclusiveEvents() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-black py-28 md:py-40 overflow-hidden px-6 md:px-16"
    >
          ...
          <div className="lg:col-span-6">
            ...
            <div className="overflow-hidden">
              ...
              >
                More than
                <br />
                <span className="text-[#BCBEC0] italic">just cars.</span>
              </motion.h2>
            </div>
          </div>
          <motion.p
            ...
            animate={inView ? {opacity: 1, y: 0} : {}}
            transition={{duration: 0.8, delay: 0.2, ease: EASE_OUT_EXPO}}
            className="lg:col-span-4 lg:col-start-9 text-sm text-[#BCBEC0]/40 leading-relaxed"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8">
              <p className="text-[9px] tracking-[0.3em] text-[#BCBEC0] uppercase mb-1">
                Annual
              </p>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 gap-4 lg:gap-6">
            ...
            <motion.div
              ...
              style={{minHeight: 240}}
            >
              <div className="absolute inset-0 bg-black border border-[#BCBEC0]/20" />
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                <span className="font-mono text-4xl text-[#BCBEC0] mb-2">
                  12+
                </span>
                <span className="text-[10px] tracking-[0.25em] text-[#BCBEC0]/40 uppercase">
                  Exclusive events per year
                </span>
                <a
                  href="/contact?subject=events"
                  className="mt-6 text-[10px] tracking-[0.2em] text-[#BCBEC0] uppercase border-b border-[#BCBEC0]/30 pb-px hover:border-[#BCBEC0] transition-colors"
                >
                  View Event Calendar →
                </a>
              </div>
...
function Testimonials() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-white py-28 md:py-40 px-6 md:px-16 overflow-hidden"
    >
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="space-y-0 border-t border-black/10">
          {testimonials.map((t, i) => (
            <motion.blockquote
              ...
              className="group grid grid-cols-12 items-start gap-6 py-10 border-b border-black/10 hover:border-[#BCBEC0]/20 transition-colors duration-500"
            >
              <div className="col-span-1 hidden lg:flex">
                <div className="w-9 h-9 rounded-full bg-[#BCBEC0]/10 border border-[#BCBEC0]/20 flex items-center justify-center">
                  <span className="font-mono text-xs text-[#BCBEC0]">
                    {t.initial}
                  </span>
                </div>
              </div>
              <p className="col-span-12 lg:col-span-8 font-display text-xl md:text-2xl text-black leading-[1.3] italic group-hover:text-[#BCBEC0] transition-colors duration-300">
                "{t.quote}"
              </p>
              <footer className="col-span-12 lg:col-span-3 lg:col-start-10 text-right">
                <p className="text-xs text-black font-medium tracking-wide mb-0.5">
                  {t.author}
                </p>
                <p className="text-[10px] tracking-[0.15em] text-[#BCBEC0]/50 uppercase">
                  {t.role}
                </p>
              </footer>
            </motion.blockquote>
...
function FAQSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-black py-28 md:py-40 px-6 md:px-16 overflow-hidden"
    >
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
        <div className="lg:col-span-4 lg:sticky lg:top-24 lg:self-start">
          ...
          <motion.p
            ...
            className="text-xs text-[#BCBEC0]/40 leading-relaxed mb-8"
          >
          ...
          >
            <Button variant="secondary" size="md" href="tel:+97100000000">
              Call a Specialist <span className="ml-2">→</span>
            </Button>
          </motion.div>
        </div>
        <div className="lg:col-span-7 lg:col-start-6 border-t border-[#BCBEC0]/20">
          {faqs.map((faq, i) => (
            <motion.div
              key={i}
              initial={{opacity: 0}}
              ...
              className="border-b border-[#BCBEC0]/20"
            >
              <button
                onClick={() => setOpenIndex(openIndex === i ? null : i)}
                className="w-full flex items-start justify-between gap-6 py-7 text-left group"
              >
                <span className="font-display text-base md:text-lg text-white group-hover:text-[#BCBEC0] transition-colors duration-300 leading-snug">
                  {faq.question}
                </span>
                <motion.span
                  animate={{rotate: openIndex === i ? 45 : 0}}
                  transition={{duration: 0.3, ease: EASE_OUT}}
                  className="text-[#BCBEC0] text-xl mt-0.5 flex-shrink-0"
                >
                  +
                </motion.span>
              </button>
              <AnimatePresence>
                {openIndex === i && (
                  ...
                  >
                    <p className="text-sm text-[#BCBEC0]/50 leading-relaxed pb-7 max-w-lg">
                      {faq.answer}
                    </p>
                  </motion.div>
                )}
